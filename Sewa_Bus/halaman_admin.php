...
<table class="table table-striped">
  <thead>
    ...
    while($user_data = mysqli_fetch_array($result)) {   ?>      
        ...
        <td align='center' width='85px'><a class="btn btn-primary" href="edit.php?id_bus=<?php echo $user_data['id_bus']; ?>" role="button">Edit</a></td>
        <td align='center' width='85px'><a class="btn btn-danger" href="hapus.php?id_bus=<?php echo $user_data['id_bus']; ?>" role="button">Hapus</a></td>
